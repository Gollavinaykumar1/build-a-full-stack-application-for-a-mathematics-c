# main.py — Generated by VIA for: Build a full stack application for a mathematics calculator with a FastAPI backend, REST APIs, and PostgreSQL database with a React frontend
